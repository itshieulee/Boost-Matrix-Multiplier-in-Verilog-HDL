...
HD_PWD='C:/Users/pc/Documents/vivado/ASS_HDL/ASS_HDL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Matrix_multi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Matrix_multi.tcl
