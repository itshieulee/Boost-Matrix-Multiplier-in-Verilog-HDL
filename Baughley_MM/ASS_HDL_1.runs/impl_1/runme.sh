...
HD_PWD='C:/Users/pc/Documents/vivado/ASS_HDL_1/ASS_HDL_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Matrix_multi.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Matrix_multi.tcl -notrace
